    ...
    return (
        ...
        >
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                <DialogHeadless.Panel className="dark:bg-gray-600 dark:border-gray-700 mx-auto flex max-h-[95%] min-w-[200px] max-w-[95%] flex-col gap-4 rounded-3xl border-8 border-slate-400 bg-slate-300 p-3 shadow-xl  shadow-gray-800">
